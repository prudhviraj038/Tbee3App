...
public class CatlistAdapter2 extends BaseAdapter {
    private Activity activity;
    public List<String> mItems = new ArrayList<String>();
    private static LayoutInflater inflater=null;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();

    public CatlistAdapter2(Activity activity, List<String> mItems,List<String> mIds) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.cat_preview2, null);
        if (imageLoader == null)
