...
public class WantedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wanted_product_details_layout);
        ...
        select_category_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WantedActivity.this, CategorySelectActivity.class);
    ...
    private  void submit_wanted_post(){
        final ProgressDialog progressDialog = new ProgressDialog(WantedActivity.this);
        progressDialog.setMessage("uploading product details...");
        progressDialog.show();
        String url = "";
                try {
            url = Settings.SERVER_URL + "insert-wanted.php?category=" + selected_category_id +
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                try {
                    ...
                    if (response_json.equals("Inserted Successfully")) {
                         Toast.makeText(WantedActivity.this, "Your add was posted successfullt", Toast.LENGTH_SHORT).show();
                        finish();
                    }
