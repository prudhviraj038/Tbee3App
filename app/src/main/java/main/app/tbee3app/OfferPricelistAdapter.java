...
public class
        OfferPricelistAdapter extends BaseSwipeAdapter {
    ...
    public OfferPricelistAdapter(Context activity,boolean candelete, List<String> mItems,
    ...
    public View generateView(final int position, ViewGroup viewGroup) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.offer_price_preview_swipe, null);
            ...
            public void onClick(View view) {
              ...
              //  delete_offer_from_server(mIds.get(position));
                ...
                if(mContext instanceof ProductDetailsActivity){
                    ((ProductDetailsActivity)mContext).delete_offer_from_server(position);
                }
