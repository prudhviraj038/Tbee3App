    ...
    public static class ScreenSlidePageFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ViewGroup rootView = (ViewGroup) inflater.inflate(
                    R.layout.fragment_layout_2, container, false);
            switch (position)
            {
                case 0:
                ...
                case 2:
                    rootView = (ViewGroup) inflater.inflate(R.layout.welcome_screen3, container, false);
                    break;
                case 3:
                    rootView = (ViewGroup) inflater.inflate(R.layout.welcome_screen4, container, false);
                    break;
                case 4:
                    rootView = (ViewGroup) inflater.inflate(R.layout.welcome_screen5, container, false);
                    break;
                case 5:
                    rootView = (ViewGroup) inflater.inflate(R.layout.welcome_screen6, container, false);
                    break;
                case 6:
                    rootView = (ViewGroup) inflater.inflate(R.layout.welcome_screen7, container, false);
                    break;
                case 7:
                    rootView = (ViewGroup) inflater.inflate(R.layout.welcome_screen8, container, false);
                    break;
                case 8:
